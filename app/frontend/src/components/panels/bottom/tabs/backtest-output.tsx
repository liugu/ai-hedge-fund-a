      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          ...
          <div className="space-y-2">
            <h4 className="font-medium">绩效指标</h4>
          ...
          {/* Exposure Metrics */}
          <div className="space-y-2">
            <h4 className="font-medium">敞口指标</h4>
            <div className="space-y-1 text-sm">
          ...
          <div>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead>代码</TableHead>
                  <TableHead>多头持仓</TableHead>
                  <TableHead>空头持仓</TableHead>
...
function BacktestPerformanceMetrics({ agentData }: { agentData: Record<string, any> }) {
  ...
  return (
    <Card className="bg-transparent mb-4">
      <CardHeader>
        <CardTitle className="text-lg">绩效表现</CardTitle>
      </CardHeader>
      <CardContent>
